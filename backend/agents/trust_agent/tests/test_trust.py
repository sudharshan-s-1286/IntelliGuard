...
from agents.trust_agent.agent import AnalysisPipeline
...
from agents.trust_agent.schemas import TrustAnalysisRequest
...
async def test_trust_agent_pipeline_with_mock_detector() -> None:
    ...
    assert res_risk.overall_status in ("MEDIUM_RISK", "HIGH_RISK", "CRITICAL_RISK")
    assert res_risk.trust_score < 90.0
