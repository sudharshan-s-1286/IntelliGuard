...
export const kpiData = [
  ...
  { title: "Security Events Today", value: "1,204", trend: "-5.4%" },
...
export const agentPerformanceData = [
  { name: 'Security Agent', response: '14ms', accuracy: '99.9%', confidence: '95%', health: '100%', risk: 'Low', requests: '1.4M' },
...
export const threatFeed = [
  { time: "10 mins ago", event: "Critical Prompt Injection Blocked", agent: "Security Agent", desc: "Blocked SQLi payload targeting internal CRM DB.", severity: "critical" },
...
export const recommendations = [
  { title: "Increase Security Threshold", desc: "Spike in injection attempts detected between 12:00 and 16:00.", action: "Review Thresholds" },
