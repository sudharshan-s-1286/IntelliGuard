...
const mockAuditLogs = [
  {
    ...
    decision: "Blocked", riskScore: 94, agent: "Trust", status: "Critical",
    ...
    timeline: [
      ...
      { time: "14:32:01", event: "Trust Agent pattern matched malicious syntax" },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#120809] via-[#1A090D] to-[#2A0B12] text-slate-200 p-4 md:p-8 font-sans selection:bg-[#DC143C]/30 relative overflow-hidden z-0">
      ...
      <div className="w-full">
        <PageHeader 
          title="Audit Logs" 
          description="Comprehensive immutable record of all AI interactions, agent decisions, and trust events."
          actions={
