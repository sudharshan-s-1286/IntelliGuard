              ...
              <div className="space-y-8 animate-in fade-in duration-300">
                ...
                <div className="space-y-6 max-w-2xl">
                  ...
                  <div>
                    ...
                    <input type="email" defaultValue="trust@acmecorp.com" className="w-full bg-[#120809] border border-[#4B0F18] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[#DC143C] transition-colors" />
                  </div>
            ...
            {activeTab === 'agents' && (
              <div className="space-y-8 animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {['Trust Agent', 'Privacy Agent', 'Compliance Agent', 'Trust Agent', 'Decision Agent', 'Remediation Agent'].map((agent, i) => (
